...
def test_robust_cli_agent_init():
    ...
    assert agent.default_timeout == 600.0, "Default timeout should be 600s"
...
def test_claude_cli_agent_init():
    ...
    assert agent.default_timeout == 600.0, "Should inherit 600s timeout"
...
def test_gemini_agent_init():
    ...
    assert agent.default_timeout == 600.0, "Should have 600s timeout"
