#!/usr/bin/env python3
"""
Generate comprehensive experiment report and tables from JSON results

This script reads all comparison.json files and generates:
1. EXPERIMENT_REPORT.md - Complete experiment documentation
2. 5 publication tables (Markdown + LaTeX)
3. Raw data backup (JSON + CSV + metadata)
"""
...
TEST_GROUPS = [
    {"id": "db_product_sales", "tasks": 2, "structure": "Linear", "description": "Find high-sales products and analyze their ratings"},
    {"id": "os_user_analysis", "tasks": 3, "structure": "Linear", "description": "Extract users and analyze their files"},
    {"id": "os_system_health_fanout", "tasks": 8, "structure": "Fan-out", "description": "Comprehensive system health check with parallel analysis"},
    {"id": "web_scraping_fanout", "tasks": 12, "structure": "Fan-out", "description": "Parallel web scraping and data aggregation"},
    {"id": "data_pipeline_mixed", "tasks": 16, "structure": "Mixed", "description": "Complex multi-stage data processing pipeline"},
]
...
def generate_experiment_report(results: Dict[str, Any]):
    ...
    print("📝 Generating EXPERIMENT_REPORT.md...")

    results_600s = results["600s"]
    results_60s = results["60s"]

    report = f"""# Multi-Agent Scheduler - End-to-End Evaluation Report
...
def main():
    ...
    print(f"📄 Check: {RESULTS_DIR}/EXPERIMENT_REPORT.md\n")
